...
public class ProductController {
	...
	@PostMapping
	public ResponseEntity<Long> addProduct(@RequestBody final ProductRequest productRequest) {
	...
	public ResponseEntity<Void> reduceQuantity(@PathVariable("id") final long productId,
	...
	@DeleteMapping("/{id}")
	public void deleteProductById(@PathVariable("id") final long productId) {
